...
# Path to dataset
en_validation_data_path = r"A:\Projects\SanskritConversion\Sanskrit_Text_Conversion\Data Files\TestEnglish.txt"
sa_validation_data_path = r"A:\Projects\SanskritConversion\Sanskrit_Text_Conversion\Data Files\TestSanskrit.txt"

en_validation_data = read_files(en_validation_data_path)
sa_validation_data = read_files(sa_validation_data_path)

# Consider only sentences with length <= 500
max_lenght = 500
val_examples = [[sa_sentence, en_sentence] for sa_sentence, en_sentence in zip(sa_validation_data, en_validation_data) if len(sa_sentence) <= max_lenght and len(en_sentence) <= max_lenght]

translator = PtEnTranslator(r"A:\Projects\SanskritConversion\Models\09_translation_transformer\202503041429\model.onnx")
